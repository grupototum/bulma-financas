...
export default function CategoriesPage() {
  ...
  async function deleteCategory(id: string) {
    if (!confirm("Tem certeza? Todas as transações desta categoria ficarão sem categoria.")) return;
    const supabase = createClient();
                ...
                <div className="flex items-start justify-between">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-gray-500 capitalize">{c.type === "expense" ? "Despesa" : c.type === "income" ? "Receita" : "Ambos"}</p>
                    </div>
                  </div>
                  <button
                  ...
                  <div className="mt-3">
                    <div className="flex justify-between text-sm">
                      ...
                      <span className="font-medium">
                        R$ {c.budget_limit.toLocaleString("pt-BR", { minimumFractionDigits: 2 })}
                      </span>
                    </div>
                  </div>
                )}
